...
# RUN 1
# Run the job
sudo su - hdfs -c "hadoop jar /opt/cloudera/parcels/CDH-5.13.1-1.cdh5.13.1.p0.2/lib/hadoop-mapreduce/hadoop-mapreduce-client-jobclient-tests.jar TestDFSIO -read -nrFiles $nrFiles -fileSize $fileSize"
#sleep 1m
# RUN 2
